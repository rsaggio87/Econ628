...
b) You decided to impose the following two assumptions: $W_{i1}-W_{i0}=\beta$ and $E_{i1}\geq E_{i0}$. Comment on these two assumptions given the empirical setting just described.
