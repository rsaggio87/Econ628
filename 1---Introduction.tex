...
%%%%%%%%%%%%
\begin{frame}
\frametitle{Skill Sets}
\begin{itemize}
\item Each stage requires its own set of skills
\bigskip
\item Idea: creativity, familiarity with existing literature, knowledge of institutional details, econometric skills (``see a research design")
\bigskip
\bigskip
\item Build: attention to detail, coding skills, lots of patience.
\bigskip
\bigskip
\item Analysis: understanding of economics, econometrics and the linkage of the two, efficiency in summarizing key patterns and ruling out others all with a commitment to scientific objectivity.
\bigskip
\bigskip
\item Marketing: writing and presentation of your work.
\bigskip
\bigskip
\pause
\item Increasing common to work in ``teams".
\end{itemize}
\end{frame}
%%
\begin{frame}
\frametitle{The Idea stage}
\begin{itemize}
\item Best empirical projects: ``shift priors".
\bigskip
\item Good empirical papers provide facts while ruling out other patterns in a convincing way.
\bigskip
\item Also needs to be consequential (``Macro" angle).
\bigskip
\item Some general tips:
\bigskip
\pause
\begin{itemize}
\bigskip
\item \textit{Know your audience.}
\bigskip
\item \textit{One side test projects are risky.}
\bigskip
\item \textit{Treatment must be measured accurately.}
\bigskip
\item \textit{Bias/Variance trade offs matter.}
\bigskip
\item \textit{Focus on your comparative advantage.}
\end{itemize}
\end{itemize}
\end{frame}
%%
\begin{frame}[shrink=2]
\frametitle{The Build stage}
\begin{itemize}
\item Every empirical project \underline{must} have a script called ``build"
\bigskip
\pause
\item A build script:
\bigskip
\begin{itemize}
\item Reads raw data, cleans it, save a ``analysis" file.
\bigskip
\item Nothing glamorous about this but immensely important.
\bigskip
\item You can spend 2 years of grad school just working on a build script. THIS IS NORMAL
\end{itemize}
\bigskip
\item Some tips:
\begin{itemize}
\bigskip
\item \textit{Check your raw data}
\bigskip
\item \textit{NEVER WORK IN THE COMMAND WINDOW}
\bigskip
\item \textit{Keep log files}
\bigskip
\item \textit{Test and verify your knowledge of the data}
\bigskip
\item \textit{Store your data somewhere safe (learn Github and/or use Dropbox)}
\bigskip
\item \textit{Chill.}
\end{itemize}
\end{itemize}
...
%%
\begin{frame}
\frametitle{The Analysis stage}
\begin{itemize}
\item Analysis script that will eventually create all your tables and figures.
\bigskip
\pause
\item Some tips
\bigskip
\begin{itemize}
\item \textit{Start simple}.
\bigskip
\item \textit{Change one thing at the time (and keep track of them)}.
\bigskip
\item \textit{Automate tables}.
\bigskip
\item \textit{Aesthetic matters}.
\bigskip
\item \textit{Check magnitudes}.
\bigskip
\bigskip
\item \textit{Always report number of observations}.
\bigskip
\item \textit{Tell the truth}.
\end{itemize}
\end{itemize}
\end{frame}
%%%%%%%%%%%%
\begin{frame}
\frametitle{Marketing Stage}
\begin{itemize}
\item This is the final phase of your empirical project. It is when you are going to communicate your results via either a paper or some presentation.
\bigskip
\item Vast majority of students underestimate the importance of this stage.
\bigskip
\item Being able to communicate in simple and plain words the key core idea of your paper is crucial.
\bigskip
\item Most JM talks / paper rejection occur because presentation / writing is not clear.
\pause
\bigskip
\item \textit{Make nice to read tables and figures. Reader be able to understand what is going without having to read the entire paper.}.
\bigskip
\item \textit{Attend all seminar presentations in your field}.
\bigskip
\item \textit{Practice a lot your JM talk}.
\bigskip
\item \textit{Pass the grandma test.}
\end{itemize}
\end{frame}
%%%%%%%%%%%%
