...
\end{frame}
\begin{frame}
\frametitle{Audit Studies: Bertrand and Mullainathan (2004)}
\begin{figure}[htb]
\centering
\includegraphics[height=0.85\textheight,keepaspectratio]{aux/bertrand_mullainathan}
\end{figure}
\end{frame}
%%
\begin{frame}
\frametitle{Blind Auditions: Goldin and Rouse (2000)}
\begin{figure}[htb]
\centering
\includegraphics[height=0.85\textheight,keepaspectratio]{aux/goldin_rouse}
\end{figure}
\end{frame}
%%
